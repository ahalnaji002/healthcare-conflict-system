      ...
      <main className="dashboard-main">
        <header className="dashboard-topbar">
          <div>
            ...
            <p>
              Manage system preferences, security settings, notifications, and
              role permissions.
            </p>
          </div>
              ...
              <div className="permissions-grid">
                ...
                <div className="permission-card">
                  <div>
                    <h3>NGOs</h3>
                    <p>
                      Can view assistance requests and manage resource
                      allocation.
                    </p>
                  </div>
                ...
                <div className="permission-card">
                  <div>
                    <h3>Admins</h3>
                    <p>
                      Can manage users, records, logs, reports, and settings.
                    </p>
                  </div>
            ...
            <div className="panel">
              <div className="panel-header">
                <div>
                  ...
                  <p>
                    Configure alerts for emergencies, appointments, and
                    approvals.
                  </p>
                </div>
              </div>
              ...
              <div className="settings-list">
                ...
                <div className="settings-item">
                  ...
                  <div>
                    ...
                    <p>
                      Enable patient medication reminders and notifications.
                    </p>
                  </div>
          ...
          <div className="content-right">
            ...
            <div className="panel">
              ...
              <div className="reminder-note">
                <h3>Last Backup</h3>
                <p>
                  System backup completed successfully 6 hours ago. Next backup
